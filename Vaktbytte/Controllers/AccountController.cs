    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginViewModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError("", "Invalid password. Please enter the correct secret word");
                }
            }
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> LoginOriginal(LoginViewModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
